...
if __name__ == '__main__':
    ...
    dummy = {'n_estimators':[50, 100, 200], 'max_depth':[10, 20, 30]}
    ...
    updated_pipeline = pipeline.set_params(**{"classifier__"+k: dummy[k][v] for k, v in best.items()})
    # retrain model with best hyperparameters
    updated_pipeline.fit(X_train, y_train)
    accuracy = evaluate_model(updated_pipeline, X_test, y_test)
